...
import { Plus, Search, Filter, Target, Trash2 } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Gerencie seus hábitos recorrentes
            </p>
          </div>
              ...
              <HabitCard
                ...
                onDelete={(habit) => (
                  <ConfirmationModal
                    ...
                    description={`Esta ação não pode ser desfeita. Isso irá permanentemente deletar o hábito "${habit.title}" e remover todos os seus dados e progresso.`}
                    confirmText="DELETAR"
