...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const unsubscribeHabits = subscribeToUserHabits(user.uid, (fetchedHabits) => {
    ...
    <AppLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Acompanhe seu progresso e gerencie suas atividades</p>
        </div>
